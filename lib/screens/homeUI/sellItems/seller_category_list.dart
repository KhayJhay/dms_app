...
class SellerCategoriesPage extends StatelessWidget {
  static String id = 'SellerCategoriesPage';
  const SellerCategoriesPage({Key? key}) : super(key: key);
                ...
                child: Card(
                  child: ListTile(
                    onTap: (){
                      ...
                      if(doc['subCat']==null){
                        Navigator.pushNamed(context, SellFoodForm.id) as Widget;
                      }
                      Navigator.pushNamed(context, SellerSubCat.id, arguments: doc);
                    },
